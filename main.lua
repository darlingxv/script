...
-- ... (código anterior do módulo Murder Mystery 2 permanece igual)
...
local function startCoinFarm()
	if coinFarming then 
		fu.notification("Already coin farming.") 
		return 
	end
	...
	coinFarmLoop = task.spawn(function()
		...
		coinFarming = false
		reClip()
		fu.notification("Coin farming stopped. Collected " .. coinCollected .. " coins.")
		coinCollected = 0
		coinBlacklists = {}
	end)
end
